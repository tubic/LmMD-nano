...
class AntibodyComplexDataset(FairseqDataset):
    ...
    def __getitem__(self, idx):
        item = self.data[idx]
        pdb_id = item['pdb']  # 添加这一行
        original_antibody_seq = item['antibody_seq_str']
        return pdb_id, item['masked_antibody_seq'], item['antibody_cdr'], item['label_antibody_seq'], \
               ...
               item['antibody_coords'], item['antibody_seq'], item['cdr_string'], original_antibody_seq
    ...
    def collate_fn(self, batch):
        try:
            pdb_ids, masked_antibody_seq, antibody_cdr, label_antibody_seq, \
            ...
            antibody_coords, antibody_seq, cdr_string, original_antibody_seq \
            = tuple(zip(*batch))
        except:
            return None
        ...
        return pdb_ids, batched_seq, batched_tag, batched_label, paratope, epitope, antibody, original_antibody_seq
