SEQ_DATA_DIR=/home/data_cdef/bo_sun/trans_ABGNN_4090/ABGNN/abgnn/final_3_data/seq
TAG_DATA_DIR=/home/data_cdef/bo_sun/trans_ABGNN_4090/ABGNN/abgnn/final_3_data/tag
...
MAX_SENTENCES=${3:-128}        # Number of sequences per batch (batch size)
UPDATE_FREQ=${4:-4}         # Increase the batch size 16x
SAMPLE_MODE=${5:-"none"}
CLIP_NORM=${6:-0.0}
...
MODLE_PATH=checkpoints/pretrained/Finanl_new_RoPE_decoder_$MODEL_NAME
